...
public class Robot {
    ...
    public Servo rightArmHingeServo, leftArmHingeServo;
    ...
    public Robot(HardwareMap hardwareMap) {
        ...
        OperationTools.apply(device -> device.setDirection(DcMotorSimple.Direction.REVERSE), backLeftDriveMotor, leftIntakeMotor, extensionSlideMotor);
